...
<h2 class="bg-info my-3">Form Tambah Data Keluarga</h2>
<!-- < ?= $validation->listErrors ; ? > -->
<form action="/Keluarga/save" method="post" enctype="multipart/form-data">
    <?= csrf_field(); ?>
    <div class="row mb-3">
        <label for="namaLengkap" class="col-sm-2 col-form-label">Nama Lengkap</label>
        <div class="col-sm-10">
            <input type="text" class="form-control <?= ($validation->hasError('nama_lengkap')) ? 'is-invalid' : ''; ?>" id="namaLengkap" name="nama_lengkap" value="<?= old('nama_lengkap'); ?>"autofocus >
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control <?= ($validation->hasError('jenis_pekerjaan')) ? 'is-invalid' : ''; ?>" id="jenisPekerjaan" name="jenis_pekerjaan" value="<?= old('jenis_pekerjaan'); ?>">
            <div id="validationServerUsernameFeedback" class="invalid-feedback">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <input class="form-control <?= ($validation->hasError('foto_keluarga')) ? 'is-invalid' : ''; ?>" type="file" id="fotoKeluarga" name="foto_keluarga" value="<?= old('foto_keluarga'); ?>">
            <div id="validationServerUsernameFeedback" class="invalid-feedback">
                <?= $validation->getError('foto_keluarga'); ?>
            </div>
        </div>
    </div>
    <button class="btn btn-primary mb-2" type="submit">Tambah Data</button>
